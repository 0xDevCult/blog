...
test.describe('Blog Post', () => {
  ...
  test('should have theme toggle', async ({ page }) => {
    ...
    const themeButton = page.locator('button[aria-label*="theme" i], select[aria-label*="theme" i]');
  ...
  test('should have social links in header', async ({ page }) => {
    ...
    const socialLinks = page.locator('a[href*="github.com"], a[href*="x.com"], a[href*="linkedin.com"]');
